...
## Active task — MiniMax-M3-VL build (full VL, int6-g64). Fleet otherwise complete.

**NOW IN FLIGHT: MiniMax-M3-VL serving runtime + int6 bake.** Handover **`PLAN_minimax_m3.md`**.
...
**full VL now** + **int6-g64 for margin** (skip int4). **M0 ✅ (this commit)** — groundwork,
